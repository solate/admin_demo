...
func (l *GetInventoryHistoryLogic) GetInventoryHistory(req *types.InventoryListReq) (*types.InventoryListResp, error) {
	// 构建查询条件
	...
	if err != nil {
		l.Error("GetInventoryHistory PageList err:", err.Error())
