...
import (
	...
	auth "admin_backend/internal/handler/auth"
	dict "admin_backend/internal/handler/dict"
	menu "admin_backend/internal/handler/menu"
	organization "admin_backend/internal/handler/organization"
	permission "admin_backend/internal/handler/permission"
	role "admin_backend/internal/handler/role"
	task "admin_backend/internal/handler/task"
	tenant "admin_backend/internal/handler/tenant"
	user "admin_backend/internal/handler/user"
