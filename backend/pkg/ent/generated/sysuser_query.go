...
func (suq *SysUserQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (suq *SysUserQuery) FirstIDX(ctx context.Context) int {
...
func (suq *SysUserQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (suq *SysUserQuery) OnlyIDX(ctx context.Context) int {
...
func (suq *SysUserQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (suq *SysUserQuery) IDsX(ctx context.Context) []int {
	ids, err := suq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (suq *SysUserQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(sysuser.Table, sysuser.Columns, sqlgraph.NewFieldSpec(sysuser.FieldID, field.TypeInt))
	_spec.From = suq.sql
