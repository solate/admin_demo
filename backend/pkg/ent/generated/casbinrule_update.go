...
func (cru *CasbinRuleUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *CasbinRuleUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (cruo *CasbinRuleUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *CasbinRuleUpdateOne {
...
func (cruo *CasbinRuleUpdateOne) sqlSave(ctx context.Context) (_node *CasbinRule, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "CasbinRule.id" for update`)}
	}
