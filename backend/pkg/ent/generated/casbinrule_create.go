...
func (crc *CasbinRuleCreate) check() error {
	if _, ok := crc.mutation.Ptype(); !ok {
		return &ValidationError{Name: "Ptype", err: errors.New(`generated: missing required field "CasbinRule.Ptype"`)}
	}
	if _, ok := crc.mutation.V0(); !ok {
		return &ValidationError{Name: "V0", err: errors.New(`generated: missing required field "CasbinRule.V0"`)}
	}
	if _, ok := crc.mutation.V1(); !ok {
		return &ValidationError{Name: "V1", err: errors.New(`generated: missing required field "CasbinRule.V1"`)}
	}
	if _, ok := crc.mutation.V2(); !ok {
		return &ValidationError{Name: "V2", err: errors.New(`generated: missing required field "CasbinRule.V2"`)}
	}
	if _, ok := crc.mutation.V3(); !ok {
		return &ValidationError{Name: "V3", err: errors.New(`generated: missing required field "CasbinRule.V3"`)}
	}
	if _, ok := crc.mutation.V4(); !ok {
		return &ValidationError{Name: "V4", err: errors.New(`generated: missing required field "CasbinRule.V4"`)}
	}
	if _, ok := crc.mutation.V5(); !ok {
		return &ValidationError{Name: "V5", err: errors.New(`generated: missing required field "CasbinRule.V5"`)}
	}
	return nil
}
...
func (u *CasbinRuleUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CasbinRuleCreate.OnConflict")
	}
...
func (u *CasbinRuleUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the CasbinRuleCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CasbinRuleCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
